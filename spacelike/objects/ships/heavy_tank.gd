...
var primary_weapon: PackedScene = preload("res://objects/weapons/primary/laser_cannon.tscn")  # Example weapon
...
var special_ability: PackedScene = preload("res://objects/special_abilities/overdrive.tscn")  # Example ability
...
func fire_primary_weapon():
	...
	await _set_cooldown(1, "primary_weapon_ready")  # Cooldown of 1 second
...
func fire_secondary_weapon():
	...
	await _set_cooldown(2, "secondary_weapon_ready")  # Cooldown of 2 seconds
...
# Handles using the special ability (e.g., armor boost)
